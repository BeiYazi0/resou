...
def get_data(html):
    ...
    regex = re.compile('<div class="lemmaSummary_cFhDf J-summary">(\s*)<a name="lemma-summary" class="lemmaSummaryAnchor_k1Aqi"></a>(\s*)<div class="para_wER59 summary_EGg7N MARK_MODULE" data-tag="paragraph" data-uuid="[\w]*" data-idx="">([\s\S]*?)</div>(\s*)</div>')
    data = re.findall(regex, html)[0][2]
    return data
